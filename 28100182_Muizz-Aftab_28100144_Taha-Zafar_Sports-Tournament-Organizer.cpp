...
int main(){
    ...
    RenderWindow sorry(VideoMode(700, 700), "Sorry Message");
    ...
    switch_to_console.setStyle(Text::Bold);
...
int scoreValidation(int n){
        ...
        if(cin>>n){
            if(n>=0){
                ...
                cin.ignore(50,'\n');
            cout<<"Invalid Input, only positive integers are allowed"<<endl;
            }
        }
       else{
        cin.clear();
