...
void sportTypeValidation(char &c);
void formatTypeValidation(char &c);
...
void getUniqueTeams(string teams[], int no_of_teams);
...
int main(){
    ...
    while (team_input.isOpen()) {
        ...
        while (team_input.pollEvent(event)) {
            ...
            if ((team_input_screen == 0 || team_input_screen == 1) && event.type == Event::TextEntered) {
                ...
                if (isprint(input_char)) { // Ensure printable characters
                    if (word.length() < 20) { // Limit input length
                        word += input_char;
                    }
            ...
            if (event.type == Event::KeyPressed && event.key.code == Keyboard::Enter) {
                if (team_input_screen == 0) { // Validate number of teams
                    ...
                    if (no_of_teams > max_teams) {
                        ...
                        if (no_of_teams == -1) { // Invalid input
                            input_error = true;
    ...
    for (int i = 0; i < no_of_teams; i++) {
        cout <<i+1<<"    "<< input_teams[i] << endl;
    }


    ///////////////////////////////////////////////end of team input window/////////////////////////////////////////
    ////////////////////////////////////////////////sorry text window///////////////////////////////////////////////
...
// int noOfTeamsValidation(int n, char format_type){  //no of teams entered validation
//     while(true){
