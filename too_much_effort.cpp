...
void fileFootballStandingsTable(fstream &file,string teams[],float scores[],int w[],int d[],int l[],int gf[],int ga[],int gdiff[],int num){
    file<<left<<setw(4)<<"Pos"<<setw(20)<<"Team"<<setw(10)<<"Wins"<<setw(10)<<"Draws"<<setw(10)<<"Losses"<<setw(10)<<"Points"<<setw(15)<<"Goals For"<<setw(15)<<"Goals Aga"<<setw(15)<<"Goal Diff"<<endl;
    file<<""<<endl;
    for (int x= 0;x<num;x++){
        file<<left<<setw(4)<<to_string(x+1)+"."<<setw(20)<<teams[x]<<setw(10)<<w[x]<<setw(10)<<d[x]<<setw(10)<<l[x]<<setw(10)<<scores[x]<<setw(15)<<gf[x]<<setw(15)<<ga[x]<<setw(15)<<gdiff[x]<<endl;
    }
}
...
int maxScoreValidation(int n,int max){
        ...
        if(cin>>n){
            ...
            cout<<"Invalid Input, input must be less than or equal to "<<max<<endl;
        }
    }
       else{
        cin.clear();
...
void ttValStanding(string teams[],float scores[],int w[],int l[],int sw[],int sl[],int num){
    cout<<left<<setw(4)<<"Pos"<<setw(20)<<"Team"<<setw(10)<<"Wins"<<setw(10)<<"Losses"<<setw(10)<<"Points"<<setw(15)<<"Sets Won"<<setw(15)<<"Sets Lost"<<endl;
    cout<<endl;
    for (int x= 0;x<num;x++){
        cout<<left<<setw(4)<<to_string(x+1)+"."<<setw(20)<<teams[x]<<setw(10)<<w[x]<<setw(10)<<l[x]<<setw(10)<<scores[x]<<setw(15)<<sw[x]<<setw(15)<<sl[x]<<endl;
    }
}

void fileTtValStandings(fstream &file,string teams[],float scores[],int w[],int l[],int sw[],int sl[],int num){
    file<<left<<setw(4)<<"Pos"<<setw(20)<<"Team"<<setw(10)<<"Wins"<<setw(10)<<"Losses"<<setw(10)<<"Points"<<setw(15)<<"Sets Won"<<setw(15)<<"Sets Lost"<<endl;
    file<<""<<endl;
    for (int x= 0;x<num;x++){
        file<<left<<setw(4)<<to_string(x+1)+"."<<setw(20)<<teams[x]<<setw(10)<<w[x]<<setw(10)<<l[x]<<setw(10)<<scores[x]<<setw(15)<<sw[x]<<setw(15)<<sl[x]<<endl;
    }
}
